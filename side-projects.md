...
<div style="border:1px solid rgba(128,128,128,0.22);border-radius:8px;padding:1rem 1.2rem;margin:1.1em 0 1.5em">
  <div style="display:flex;align-items:baseline;gap:10px;flex-wrap:wrap;margin-bottom:0.4em">
    ...
    <a href="https://github.com/LiamMry/iv-surface-diffusion" target="_blank" style="font-size:0.85em">GitHub ↗</a>
  </div>
...
<div style="border:1px solid rgba(128,128,128,0.22);border-radius:8px;padding:1rem 1.2rem;margin:1.1em 0 1.5em">
  <div style="display:flex;align-items:baseline;gap:10px;flex-wrap:wrap;margin-bottom:0.4em">
    <span style="font-weight:600">BaseDiff — A Reusable Framework for Score-Based Diffusion Projects</span>
    <a href="https://github.com/LiamMry/basediff" target="_blank" style="font-size:0.85em">GitHub ↗</a>
  </div>
  <div style="font-size:0.9em;opacity:0.8;text-align:justify">
    A reusable code base for starting new score-based diffusion projects, distilling the components common to all of them: VP/VE SDEs with epsilon parameterization, a guided-diffusion UNet supporting 1D, 2D and 3D data, and a suite of SDE/ODE samplers (Euler-Maruyama, Euler, Heun, RK3, DPM-Solver 2). A registry-based plugin system keeps the core untouched across projects — new datasets, physics operators and conditioning methods are simply registered and selected via YAML configs. Includes Diffusion Posterior Sampling (DPS) for inverse problems and built-in evaluation metrics (PSNR, SSIM, LPIPS, FID, KID, MMD, IS).
  </div>
  <div style="margin-top:0.6em;display:flex;gap:6px;flex-wrap:wrap">
    <span style="font-size:0.75em;padding:2px 8px;border:1px solid rgba(128,128,128,0.3);border-radius:10px;opacity:0.7">Python</span>
    <span style="font-size:0.75em;padding:2px 8px;border:1px solid rgba(128,128,128,0.3);border-radius:10px;opacity:0.7">PyTorch</span>
