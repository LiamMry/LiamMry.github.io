...
<div align="center">
  ...
  <p style="font-size:0.97rem; font-style:italic; max-width:520px; margin: 0 auto 1.2rem;">
    I build theoretically-grounded generative models (diffusion, flow-matching, ...) for posterior sampling, with applications ranging from aerospace, nuclear and medical imaging.
  </p>
  <!-- Social links -->
